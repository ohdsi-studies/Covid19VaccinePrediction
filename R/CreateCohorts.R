...
.createCohorts <- function(connection,
  ...
  sql <- SqlRender::loadRenderTranslateSql(sqlFilename = "CreateCohortTable.sql",
                                           packageName = "CovidVaccinePrediction",
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "CovidVaccinePrediction")
  ...
  if(!is.null(cohortVariableSetting)){
    ...
    pathToCustom <- system.file("settings", cohortVariableSetting, package = "CovidVaccinePrediction")
