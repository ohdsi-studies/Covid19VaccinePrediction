...
populateMultipleShinyApp(shinyDirectory ="D:/GitHub/ohdsi-studies/RCRI",
                                     resultDirectory = c('D:/RCRIResults/ccae',
                                                         'D:/RCRIResults/ccae_recalibrateIntercept',
                                                         'D:/RCRIResults/ccae_recalibrate'),
                                     minCellCount = 0,
                                     databaseName = c('CCAE','CCAE','CCAE'))
